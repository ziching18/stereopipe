...
aws s3 cp s3://crm.tumorstudy.mamduh/WES/Tumor_Plate${n}/BQSR/%.recalibrated.bam /stereoseq/wes/bam/ --force-glacier-transfer; \
aws s3 cp s3://crm.tumorstudy.mamduh/WES/Tumor_Plate${n}/BQSR/%.recalibrated.bai /stereoseq/wes/bam/ --force-glacier-transfer; \
