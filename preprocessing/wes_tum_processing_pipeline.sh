...
aws s3 cp AAA.r_1_val_1.fq.gz s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/1_trim_galore_out/ ; \
aws s3 cp AAA.r_2_val_2.fq.gz s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/1_trim_galore_out/ && touch AAA.trim.success || touch AAA.trim.failed ; \
rm AAA.*.fq.gz ; \
rm AAA.*.bam ; \
rm AAA.*.fq " ;
...
aws s3 ls s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/1_trim_galore_out/ | #grep SLX-${SLX_ID}. |
awk '{print $NF}' |
grep 'fq.gz$' | grep -v 0000 |
cut -d '.' -f 1,2,3,4 | 
sort | uniq | 
xargs -P 2 -I AAA sh -c  \
" aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/1_trim_galore_out/AAA.r_1_val_1.fq.gz ./ ; \
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/1_trim_galore_out/AAA.r_2_val_2.fq.gz ./ ; \
...
aws s3 cp AAA.bwa.log s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/2_bwa_out/ ; \
aws s3 cp AAA.sorted.bam s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/2_bwa_out/ && touch AAA.map.success || touch AAA.map.failed ; \
rm AAA.*.fq.gz; \
rm AAA.*.fq; " ;
...
cd /stereoseq/all_samples/wes/${TUM_ID}/;
aws s3 ls crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/2_bwa_out/ | grep SLX-${SLX_ID}. |
...
aws s3 cp ${TUM_ID}.wes_tum.merged.bam s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/3_merged_bams/; 
aws s3 cp ${TUM_ID}.wes_tum.merged.bai s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/3_merged_bams/;
rm *.bam;
rm *.bai;
...
cd /stereoseq/all_samples/wes/${TUM_ID}/;
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/3_merged_bams/${TUM_ID}.wes_tum.merged.bam ./; 
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/3_merged_bams/${TUM_ID}.wes_tum.merged.bai ./; 
...
cd /stereoseq/all_samples/wes/${TUM_ID}/;
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/4_rga_out/${TUM_ID}.wes_tum.merged.RGA.bam ./ ; 
...
aws s3 cp ${TUM_ID}.wes_tum.dedup.bam s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/5_dedupped_bams/ ; 
aws s3 cp ${TUM_ID}.wes_tum.dedup.bai s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/5_dedupped_bams/ ; 
aws s3 cp ${TUM_ID}.wes_tum.MarkDup.metrics s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/5_dedupped_bams/ ; 
...
cd /stereoseq/all_samples/wes/${TUM_ID}/;
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/5_dedupped_bams/${TUM_ID}.wes_tum.dedup.bam ./ ; 
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/5_dedupped_bams/${TUM_ID}.wes_tum.dedup.bai ./ ;  
...
aws s3 cp ${TUM_ID}.wes_tum.split.bam s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/ ; 
aws s3 cp ${TUM_ID}.wes_tum.split.bai s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/ ; 
rm ${TUM_ID}.wes_tum.dedup.bam; 
rm ${TUM_ID}.wes_tum.dedup.bai; 
...
cd /stereoseq/all_samples/wes/${TUM_ID}/;
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/${TUM_ID}.wes_tum.split.bam ./ ; 
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/${TUM_ID}.wes_tum.split.bai ./ ;  
...
aws s3 cp ${TUM_ID}.wes_tum.recal_data.grp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/ ; 
rm ${TUM_ID}.wes_tum.split.bam; 
rm ${TUM_ID}.wes_tum.split.bai; 
...
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/${TUM_ID}.wes_tum.split.bam ./ ;  
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/${TUM_ID}.wes_tum.split.bai ./ ; 
aws s3 cp s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/6_split_bams/${TUM_ID}.wes_tum.recal_data.grp ./ ; 
...
aws s3 cp ${TUM_ID}.wes_tum.recal.bam s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/7_recal_bams/ ; 
aws s3 cp ${TUM_ID}.wes_tum.recal.bai s3://crm.steroseq.raw.data/Breast_CACRMY/all_samples/${TUM_ID}/wes_tum_corrected/7_recal_bams/ ; 
rm ${TUM_ID}.wes_tum.split.bam; 
rm ${TUM_ID}.wes_tum.split.bai; 
